/**
 * RegisterPage — redesigned account registration form.
 */
...
export default function RegisterPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-surface bg-pattern px-4 py-8">
            <div className="w-full max-w-md animate-slide-up">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-txt-secondary text-sm">
                        Đăng ký để bắt đầu sử dụng Trợ Lý Pháp Lý AI
                    </p>
                </div>
                ...
                <div className="bg-surface-card rounded-2xl p-8 shadow-card-lg border border-bdr">
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-txt-primary mb-1.5">
                                Họ và tên <span className="text-txt-muted font-normal">(không bắt buộc)</span>
                            </label>
                            <input
                                type="text"
                                value={fullName}
                    ...
                    <p className="mt-6 text-center text-sm text-txt-secondary">
                        Đã có tài khoản?{" "}
                        <Link to="/login" className="text-primary-600 hover:text-primary-700 font-semibold transition-smooth">
                            Đăng nhập
                        </Link>
                    </p>
                </div>
